...
//  ElementQuiz
//
//  Created by Iulia Anisoi on 09.12.2020.
//
...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    // For the current state of the app, how should the UI look?
    ...
    func displayScoreAlert() {
        ...
        let dismissAction = UIAlertAction(title: "OK", style: .default, handler: scoreAlertDismissed(_action:))
    ...
    func scoreAlertDismissed(_action: UIAlertAction){
        mode = .flashCard
    }
